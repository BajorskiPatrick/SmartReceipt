...
from app.models.ocr_expense_item import OcrExpenseItem
try:
...
class OcrResult(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "expenses": [OcrExpenseItem.from_dict(_item) for _item in obj.get("expenses")] if obj.get("expenses") is not None else None
        })
        return _obj
